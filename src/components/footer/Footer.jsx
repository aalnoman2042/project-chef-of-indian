...
const Footer = () => {
  const imgURL = 'https://i.ibb.co/72YHGhP/logo.png'
    return (
        <div>
           <footer className="footer p-10 bg-[#EBE6D6] text-base-content">
  <div>
...
<footer className="footer px-10 py-4 border-t bg-[#73726f]  border-base-300 text-white">

  <div className="items-center grid-flow-col">
  <div className='w-[50px] rounded-full'>
    <img  src={imgURL} alt="" />
   </div>
    <p>CHEF-OF-INDIAN <br/> since 2022</p>
  </div> 
